-- MySQL Database Setup for Dashboard Configuration
...
CREATE INDEX idx_dashboard_components_active ON dashboard_components(is_active);
CREATE INDEX idx_dashboard_tabs_active ON dashboard_tabs(is_active);
...
component_file = VALUES(component_file),
...
tab_icon = VALUES(tab_icon),
tab_order = VALUES(tab_order),
description = VALUES(description);
