...
--
-- Temporary view structure for view `approved_public_feedback`
--

DROP TABLE IF EXISTS `approved_public_feedback`;
/*!50001 DROP VIEW IF EXISTS `approved_public_feedback`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `approved_public_feedback` AS SELECT 
 1 AS `id`,
 1 AS `name`,
 1 AS `email`,
 1 AS `phone`,
 ...
 1 AS `created_at`,
 1 AS `updated_at`,
 1 AS `rating_overall_support`,
 1 AS `rating_quality_of_life_impact`,
 1 AS `rating_community_alignment`,
 1 AS `rating_transparency`,
 1 AS `rating_feasibility_confidence`,
 1 AS `moderation_status`,
 1 AS `moderation_reason`,
 1 AS `custom_reason`,
 1 AS `moderator_notes`,
 1 AS `moderated_by`,
 1 AS `moderated_at`,
 1 AS `project_name`,
 1 AS `moderator_first_name`,
 1 AS `moderator_last_name`*/;
...
CREATE TABLE `feedback_moderation` (
  ...
  `feedback_type` enum('public_feedback','project_feedback') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'public_feedback',
  `moderation_status` enum('pending','approved','rejected','flagged') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `moderation_reason` enum('inappropriate_content','spam','off_topic','personal_attack','false_information','duplicate','incomplete','language_violation','other') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `feedback_moderation_ibfk_1` FOREIGN KEY (`moderated_by`) REFERENCES `kemri_users` (`userId`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `feedback_moderation`
--

LOCK TABLES `feedback_moderation` WRITE;
/*!40000 ALTER TABLE `feedback_moderation` DISABLE KEYS */;
/*!40000 ALTER TABLE `feedback_moderation` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `feedback_moderation_settings`
--

LOCK TABLES `feedback_moderation_settings` WRITE;
/*!40000 ALTER TABLE `feedback_moderation_settings` DISABLE KEYS */;
INSERT INTO `feedback_moderation_settings` VALUES (1,'auto_approve_threshold','0.8','Confidence threshold for auto-approval (0-1)','2025-10-16 13:40:54','2025-10-16 13:40:54'),(2,'require_moderation','true','Whether all feedback requires manual moderation','2025-10-16 13:40:54','2025-10-16 13:40:54'),(3,'moderation_timeout_hours','24','Hours before feedback is auto-approved if not moderated','2025-10-16 13:40:54','2025-10-16 13:40:54'),(4,'spam_keywords','spam,scam,fake','Comma-separated keywords to flag as spam','2025-10-16 13:40:54','2025-10-16 13:40:54'),(5,'inappropriate_keywords','hate,abuse,violence','Comma-separated keywords to flag as inappropriate','2025-10-16 13:40:54','2025-10-16 13:40:54');
/*!40000 ALTER TABLE `feedback_moderation_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `kemri_departments` VALUES (1,'Energy, Transport, Roads & Public Works','Transport','','','','','','',0,1,'2025-10-15 04:52:34','2025-10-20 11:04:07',NULL),(2,'Education, Technical Training, Innovation and Social Services','Education, TTI and social services','','','','','','',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(3,'Water,Environment,Climate Change and Natural Resources','','HEADQUARTERS','2738-40100','Sospeter Onunga','0715581380','sospeterke@yahoo.com','digitization of services',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(4,'Department-Wide','','','','','','','',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(5,'Trade, Tourism,Industry and Marketing','','HQ','','Bovince Ochieng','0723106411','bovinceo@gmail.com','',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(6,'Sports,Culture,Gender and Youth Affairs','','','','','','','',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(7,'Lands, Physical Planning, Housing and Urban Development','Lands','','','','','','',0,1,'2025-10-15 04:52:34','2025-10-20 14:41:35',NULL),(8,'Medical Services, Public Health and Sanitation','','','','','','','',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(9,'Governors Servce  Delivery Unit','','','','','','','',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(10,'Finance, Economic Planning and ICT (E-Government) Services','F, EP & ICT','County Hqs','P.O. Box 2378 - 40100, Kisumu','CECM ','0712347810','','CECM, F, EP & ICT',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(11,'County Public Service Board',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(12,'Agriculture, Fisheries, Livestock Development and Irrigation','','','','','','','',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(13,'Public Service, County Administration And Participatory Development, Office Of The Governor','','','','','','','',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(14,'City of Kisumu','CITY','NEW FIRESTATION','105','CATHERINE OBOR','0724599722','candjaber@gmail.com','CITY',0,1,'2025-10-15 04:52:34','2025-10-15 04:52:34',NULL),(15,'Road Works',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2025-10-20 12:10:25','2025-10-20 12:10:25',NULL);
...
INSERT INTO `kemri_financialyears` VALUES (1,'FY2025/2026','2025-02-19 12:27:10','2026-02-18 21:00:00','Test',0,1,'2025-10-15 05:05:30','2025-10-15 05:05:30',NULL),(2,'FY2020/2021','2020-05-09 21:00:00','2021-05-09 21:00:00','',0,1,'2025-10-15 05:05:30','2025-10-15 05:05:30',NULL),(3,'FY2023/2024','2023-06-30 21:00:00','2024-06-29 21:00:00','',0,1,'2025-10-15 05:05:30','2025-10-15 05:05:30',NULL),(4,'FY2023/2024','2023-05-31 21:00:00','2024-06-29 21:00:00','',0,1,'2025-10-15 05:05:30','2025-10-15 05:05:30',NULL),(5,'FY2022/2023','2024-05-09 11:25:46','2024-05-09 11:25:46','',0,1,'2025-10-15 05:05:30','2025-10-15 05:05:30',NULL),(6,'FY2023/2024','2024-05-09 11:25:46','2024-05-09 11:25:46','',0,1,'2025-10-15 05:05:30','2025-10-15 05:05:30',NULL),(7,'FY2018/2019','2018-06-09 04:00:00','2019-06-08 01:44:02','',0,1,'2025-10-15 05:05:30','2025-10-15 05:05:30',NULL),(8,'FY2017/2018','2017-06-07 04:00:00','2018-06-08 01:44:02','',0,1,'2025-10-15 05:05:30','2025-10-15 05:05:30',NULL),(9,'FY2019/2020',NULL,NULL,NULL,0,NULL,'2025-10-15 05:56:20','2025-10-15 05:56:20',NULL),(10,'FY2021/2022',NULL,NULL,NULL,0,NULL,'2025-10-15 05:56:20','2025-10-15 05:56:20',NULL),(11,'FY2024/2025',NULL,NULL,NULL,NULL,NULL,'2025-10-20 12:10:25','2025-10-20 12:10:25',NULL);
...
INSERT INTO `kemri_project_subcounties` VALUES (176,3,'2025-10-15 05:12:57',0),(177,3,'2025-10-15 05:12:57',0),(178,1,'2025-10-15 05:13:39',0),(180,1,'2025-10-15 05:13:39',0),(181,7,'2025-10-15 05:13:39',0),(182,7,'2025-10-15 05:13:39',0),(183,1,'2025-10-15 06:09:46',0),(184,1,'2025-10-15 06:09:46',0),(185,1,'2025-10-15 06:09:46',0),(186,1,'2025-10-15 06:09:46',0),(187,1,'2025-10-15 06:09:46',0),(188,1,'2025-10-15 06:09:46',0),(189,1,'2025-10-15 06:09:46',0),(190,1,'2025-10-15 06:09:46',0),(191,1,'2025-10-15 06:09:46',0),(192,1,'2025-10-15 06:09:46',0),(193,1,'2025-10-15 06:09:46',0),(194,1,'2025-10-15 06:09:46',0),(195,1,'2025-10-15 06:09:46',0),(196,1,'2025-10-15 06:09:46',0),(197,1,'2025-10-15 06:09:46',0),(198,7,'2025-10-15 06:09:46',0),(199,7,'2025-10-15 06:09:46',0),(200,7,'2025-10-15 06:09:46',0),(201,7,'2025-10-15 06:09:46',0),(202,7,'2025-10-15 06:09:46',0),(203,7,'2025-10-15 06:09:46',0),(204,7,'2025-10-15 06:09:46',0),(205,7,'2025-10-15 06:09:46',0),(206,7,'2025-10-15 06:09:46',0),(207,7,'2025-10-15 06:09:46',0),(208,7,'2025-10-15 06:09:46',0),(209,7,'2025-10-15 06:09:46',0),(210,7,'2025-10-15 06:09:46',0),(211,7,'2025-10-15 06:09:46',0),(212,7,'2025-10-15 06:09:46',0),(213,7,'2025-10-15 06:09:46',0),(214,7,'2025-10-15 06:09:46',0),(215,7,'2025-10-15 06:09:46',0),(216,7,'2025-10-15 06:09:46',0),(217,7,'2025-10-15 06:09:46',0),(218,7,'2025-10-15 06:09:46',0),(219,7,'2025-10-15 06:09:46',0),(220,7,'2025-10-15 06:09:46',0),(221,7,'2025-10-15 06:09:46',0),(222,7,'2025-10-15 06:09:46',0),(223,7,'2025-10-15 06:09:46',0),(224,7,'2025-10-15 06:09:46',0),(225,7,'2025-10-15 06:09:46',0),(226,7,'2025-10-15 06:09:46',0),(227,7,'2025-10-15 06:09:46',0),(228,7,'2025-10-15 06:09:46',0),(229,7,'2025-10-15 06:09:46',0),(230,7,'2025-10-15 06:09:46',0),(231,7,'2025-10-15 06:09:46',0),(232,7,'2025-10-15 06:09:46',0),(233,7,'2025-10-15 06:09:46',0),(234,7,'2025-10-15 06:09:46',0),(235,7,'2025-10-15 06:09:46',0),(236,7,'2025-10-15 06:09:46',0),(238,6,'2025-10-20 12:10:25',0);
...
INSERT INTO `kemri_project_wards` VALUES (176,2,'2025-10-15 05:12:57',0),(177,2,'2025-10-15 05:12:57',0),(178,1,'2025-10-15 05:13:39',0),(180,1,'2025-10-15 05:13:39',0),(181,8,'2025-10-15 05:13:39',0),(182,19,'2025-10-15 05:13:39',0),(183,1,'2025-10-15 06:09:46',0),(184,1,'2025-10-15 06:09:46',0),(185,1,'2025-10-15 06:09:46',0),(186,1,'2025-10-15 06:09:46',0),(187,1,'2025-10-15 06:09:46',0),(188,1,'2025-10-15 06:09:46',0),(189,1,'2025-10-15 06:09:46',0),(190,1,'2025-10-15 06:09:46',0),(191,1,'2025-10-15 06:09:46',0),(192,1,'2025-10-15 06:09:46',0),(193,1,'2025-10-15 06:09:46',0),(194,1,'2025-10-15 06:09:46',0),(195,1,'2025-10-15 06:09:46',0),(196,1,'2025-10-15 06:09:46',0),(197,1,'2025-10-15 06:09:46',0),(198,19,'2025-10-15 06:09:46',0),(199,19,'2025-10-15 06:09:46',0),(200,19,'2025-10-15 06:09:46',0),(201,19,'2025-10-15 06:09:46',0),(202,19,'2025-10-15 06:09:46',0),(203,19,'2025-10-15 06:09:46',0),(204,19,'2025-10-15 06:09:46',0),(205,19,'2025-10-15 06:09:46',0),(206,19,'2025-10-15 06:09:46',0),(207,19,'2025-10-15 06:09:46',0),(208,19,'2025-10-15 06:09:46',0),(209,19,'2025-10-15 06:09:46',0),(210,19,'2025-10-15 06:09:46',0),(211,19,'2025-10-15 06:09:46',0),(212,19,'2025-10-15 06:09:46',0),(213,19,'2025-10-15 06:09:46',0),(214,19,'2025-10-15 06:09:46',0),(215,19,'2025-10-15 06:09:46',0),(216,19,'2025-10-15 06:09:46',0),(217,19,'2025-10-15 06:09:46',0),(218,19,'2025-10-15 06:09:46',0),(219,19,'2025-10-15 06:09:46',0),(220,19,'2025-10-15 06:09:46',0),(221,8,'2025-10-15 06:09:46',0),(222,19,'2025-10-15 06:09:46',0),(223,19,'2025-10-15 06:09:46',0),(224,19,'2025-10-15 06:09:46',0),(225,19,'2025-10-15 06:09:46',0),(226,19,'2025-10-15 06:09:46',0),(227,8,'2025-10-15 06:09:46',0),(228,19,'2025-10-15 06:09:46',0),(229,19,'2025-10-15 06:09:46',0),(230,19,'2025-10-15 06:09:46',0),(231,19,'2025-10-15 06:09:46',0),(232,19,'2025-10-15 06:09:46',0),(233,19,'2025-10-15 06:09:46',0),(234,19,'2025-10-15 06:09:46',0),(235,19,'2025-10-15 06:09:46',0),(236,19,'2025-10-15 06:09:46',0),(238,27,'2025-10-20 12:10:25',0);
...
CREATE TABLE `kemri_projects` (
  ...
  `ProjectRefNum` varchar(255) DEFAULT NULL,
  `Contracted` decimal(15,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_projects_name` (`projectName`),
  UNIQUE KEY `uq_projects_refnum` (`ProjectRefNum`),
...
INSERT INTO `kemri_projects` VALUES (176,'Seme HMIS Improvement v5','Health Systems Improvement ','2020-05-09 21:00:00','2024-05-10 11:16:14',7000000.00,13050000.00,'','','','','Under Procurement',NULL,'2025-10-15 05:12:57',NULL,1,NULL,2,NULL,NULL,NULL,'Seme HMIS',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'semehmisimprovementv5-0176',7000000.00),(177,'Seme HMIS Improvement','Health Systems Improvement ','2020-05-09 21:00:00','2024-05-10 11:16:14',7000000.00,0.00,'','','','','Not Started',NULL,'2025-10-15 05:12:57',NULL,1,NULL,2,NULL,NULL,NULL,'Seme HMIS',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'semehmisimprovement-0177',7000000.00),(178,'Kobura HMIS Improvement','Health Systems Improvement ','2020-05-09 21:00:00','2024-05-10 11:16:14',5000000.00,0.00,'','','','','Under Procurement','','2025-10-15 05:13:39',NULL,1,NULL,2,NULL,NULL,NULL,'Kobura HMIS',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'koburahmisimprovement-0178',5000000.00),(180,'Implementation of HMIS and Banda Level 5 Hospital','Health Systems Improvement ','2020-05-09 21:00:00','2024-05-10 11:16:14',15000000.00,0.00,'','','','','Under Procurement',NULL,'2025-10-15 05:13:39',NULL,1,NULL,2,NULL,NULL,NULL,'Banda level 5 Hospital',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'implementationofhmisandbandalevel5hospital-0180',15000000.00),(181,'COnstruction of ICT Lab Kasarani','Implementation MCH Health Systems','2023-07-01 04:00:00','2027-06-30 01:44:02',4500000.00,1500000.00,'To Improve access to sustainable safe water from 76% to 86 % by the year 2027','','','','Completed',NULL,'2025-10-15 05:13:39',NULL,1,NULL,1,NULL,NULL,NULL,'Establishing ICT lab for Kasarani',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofictlabkasarani-0181',4500000.00),(182,'','Construction of Governors House','2023-07-01 04:00:00','2027-06-30 01:44:02',50000000.00,20000000.00,'','','','','Not Started',NULL,'2025-10-15 05:13:39',NULL,1,NULL,8,NULL,NULL,NULL,'Construction and furnishing of Governors Residence',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'-0182',50000000.00),(183,'KCSAP','','2022-07-01 00:00:00','2023-06-30 00:00:00',435162538.00,0.00,'','','','','Under Procurement','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'kcsap-0183',435162538.00),(184,'ASDSP','','2022-07-01 00:00:00','2023-06-30 00:00:00',33113394.00,0.00,'','','','','Under Procurement','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'asdsp-0184',33113394.00),(185,'EU','','2022-07-01 00:00:00','2023-06-30 00:00:00',3000000.00,0.00,'','','','','Ongoing','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'eu-0185',3000000.00),(186,'Development of horticultural value chains(Assorted seeds)','','2022-07-01 00:00:00','2023-06-30 00:00:00',2000000.00,0.00,'','','','','Ongoing','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:34',NULL,0.00,NULL,NULL,'developmentofhorticulturalvaluechains(assortedseeds)-0186',2000000.00),(187,'Procurement of vaccines, acaricides','','2022-07-01 00:00:00','2023-06-30 00:00:00',3000000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'procurementofvaccines,acaricides-0187',3000000.00),(188,'Continuation of  Maseno ATC renovation','','2022-07-01 00:00:00','2023-06-30 00:00:00',3000000.00,0.00,'','','','','Not Started','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'continuationofmasenoatcrenovation-0188',3000000.00),(189,'Devlopment of prposed Agriculture Trainng Centre in Seme Sub County','','2022-07-01 00:00:00','2023-06-30 00:00:00',5000000.00,0.00,'','','','','Under Procurement','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'devlopmentofprposedagriculturetrainngcentreinsemesubcounty-0189',5000000.00),(190,'Operationalization and mainatanace of rice mill','','2022-07-01 00:00:00','2023-06-30 00:00:00',3000000.00,0.00,'','','','','Under Procurement','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'operationalizationandmainatanaceofricemill-0190',3000000.00),(191,'Dairy Cows','','2022-07-01 00:00:00','2023-06-30 00:00:00',2500000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'dairycows-0191',2500000.00),(192,'One day old chicks','','2022-07-01 00:00:00','2023-06-30 00:00:00',2000000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'onedayoldchicks-0192',2000000.00),(193,'Feed for the Chicks','','2022-07-01 00:00:00','2023-06-30 00:00:00',2000000.00,0.00,'','','','','Stalled','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'feedforthechicks-0193',2000000.00),(194,'Fish Cages for Kit Mikayi  Kama Association','','2022-07-01 00:00:00','2023-06-30 00:00:00',2800000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'fishcagesforkitmikayikamaassociation-0194',2800000.00),(195,'Completion of Achuodho Beach Management Unit (BMU) Banda','','2022-07-01 00:00:00','2023-06-30 00:00:00',1200000.00,0.00,'','','','','Ongoing','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'completionofachuodhobeachmanagementunit(bmu)banda-0195',1200000.00),(196,'Supply of Life Saving Jackets','','2022-07-01 00:00:00','2023-06-30 00:00:00',1000000.00,0.00,'','','','','Under Procurement','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'supplyoflifesavingjackets-0196',1000000.00),(197,'ABDP','','2022-07-01 00:00:00','2023-06-30 00:00:00',18798559.00,0.00,'','','','','Stalled','','2025-10-15 05:24:21',NULL,12,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'abdp-0197',18798559.00),(198,'feeding programme','','2022-07-01 00:00:00','2023-06-30 00:00:00',170000000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'feedingprogramme-0198',170000000.00),(199,'ecde infrastructure','','2022-07-01 00:00:00','2023-06-30 00:00:00',23500000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'ecdeinfrastructure-0199',23500000.00),(200,'ecd capitation','','2022-07-01 00:00:00','2023-06-30 00:00:00',21500000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'ecdcapitation-0200',21500000.00),(201,'computers and printers','','2022-07-01 00:00:00','2023-06-30 00:00:00',2850000.00,0.00,'','','','','Stalled','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'computersandprinters-0201',2850000.00),(202,'ecd advocacy','','2022-07-01 00:00:00','2023-06-30 00:00:00',1250000.00,0.00,'','','','','Under Procurement','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'ecdadvocacy-0202',1250000.00),(203,'Monitoring and assessment','','2022-07-01 00:00:00','2023-06-30 00:00:00',635000.00,0.00,'','','','','Not Started','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'monitoringandassessment-0203',635000.00),(204,'capacity building','','2022-07-01 00:00:00','2023-06-30 00:00:00',635000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'capacitybuilding-0204',635000.00),(205,'support for needy students','','2022-07-01 00:00:00','2020-06-30 00:00:00',205000000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'supportforneedystudents-0205',205000000.00),(206,'Ecd Bill/Act Drafting','','2022-07-01 00:00:00','2023-06-30 00:00:00',499000.00,0.00,'','','','','Ongoing','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'ecdbill/actdrafting-0206',499000.00),(207,'BOG constitution and inaugaration','','2022-07-01 00:00:00','2023-06-30 00:00:00',500000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'bogconstitutionandinaugaration-0207',500000.00),(208,'capitation disbursement','','2022-07-01 00:00:00','2023-06-30 00:00:00',45000000.00,0.00,'','','','','Not Started','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'capitationdisbursement-0208',45000000.00),(209,'holdig graduation','','2022-07-01 00:00:00','2023-06-30 00:00:00',350000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:34',NULL,0.00,NULL,NULL,'holdiggraduation-0209',350000.00),(210,'access,equity and quality in vtcs','','2022-07-01 00:00:00','2023-06-30 00:00:00',300000.00,0.00,'','','','','Completed','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'access,equityandqualityinvtcs-0210',300000.00),(211,'vtc infrastructure','','2022-07-01 00:00:00','2023-06-30 00:00:00',16000000.00,0.00,'','','','','Not Started','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'vtcinfrastructure-0211',16000000.00),(212,'tools and equipment for vtcs','','2022-07-01 00:00:00','2023-06-30 00:00:00',1753192.00,0.00,'','','','','Under Procurement','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'toolsandequipmentforvtcs-0212',1753192.00),(213,'capacity strengthening for vtcs','','2022-07-01 00:00:00','2023-06-30 00:00:00',360000.00,0.00,'','','','','Stalled','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'capacitystrengtheningforvtcs-0213',360000.00),(214,'marketing the vtcs through exhibitions','','2022-07-01 00:00:00','2023-06-30 00:00:00',200000.00,0.00,'','','','','Stalled','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:34',NULL,0.00,NULL,NULL,'marketingthevtcsthroughexhibitions-0214',200000.00),(215,'Collaborations through internships','','2022-07-01 00:00:00','2023-06-30 00:00:00',50000.00,0.00,'','','','','Under Procurement','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'collaborationsthroughinternships-0215',50000.00),(216,'strategic partnership and linkages in VTCs','','2022-07-01 00:00:00','2023-06-30 00:00:00',50000.00,0.00,'','','','','Under Procurement','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'strategicpartnershipandlinkagesinvtcs-0216',50000.00),(217,'talent identification and nurturing invtcs','','2022-07-01 00:00:00','2023-06-30 00:00:00',200000.00,0.00,'','','','','Stalled','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:34',NULL,0.00,NULL,NULL,'talentidentificationandnurturinginvtcs-0217',200000.00),(218,'Human resource management and development','','2022-07-01 00:00:00','2023-06-30 00:00:00',0.00,0.00,'','','','','Ongoing','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'humanresourcemanagementanddevelopment-0218',0.00),(219,'VET Policy development','','2022-07-01 00:00:00','2023-06-30 00:00:00',100000.00,0.00,'','','','','Under Procurement','','2025-10-15 05:24:21',NULL,2,NULL,5,NULL,NULL,NULL,'',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'vetpolicydevelopment-0219',100000.00),(220,'Non Motorized transport system within Kisumu City','City Infrastructure Development',NULL,NULL,50000000.00,0.00,NULL,NULL,NULL,NULL,'Ongoing',NULL,'2025-10-15 05:59:11',NULL,14,NULL,9,NULL,NULL,NULL,'City of Kisumu infrastructure project - Non Motorized transport system within Kisumu City',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'nonmotorizedtransportsystemwithinkisumucity-0220',50000000.00),(221,'Construction of Nyamasaria Satelite Buspark within Kisumu City','City Infrastructure Development',NULL,NULL,30000000.00,0.00,NULL,NULL,NULL,NULL,'Ongoing',NULL,'2025-10-15 05:59:11',NULL,14,NULL,9,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Nyamasaria Satelite Buspark within Kisumu City',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofnyamasariasatelitebusparkwithinkisumucity-0221',30000000.00),(222,'Construction of Kibuye Market phase 1','City Infrastructure Development',NULL,NULL,25000000.00,0.00,NULL,NULL,NULL,NULL,'Stalled',NULL,'2025-10-15 05:59:11',NULL,14,NULL,9,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Kibuye Market phase 1',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofkibuyemarketphase1-0222',25000000.00),(223,'Construction of Kibuye Market phase 2','City Infrastructure Development',NULL,NULL,20000000.00,0.00,NULL,NULL,NULL,NULL,'Ongoing',NULL,'2025-10-15 05:59:11',NULL,14,NULL,9,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Kibuye Market phase 2',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofkibuyemarketphase2-0223',20000000.00),(224,'Construction of Kibuye Market phase 3','City Infrastructure Development',NULL,NULL,15000000.00,0.00,NULL,NULL,NULL,NULL,'Ongoing',NULL,'2025-10-15 05:59:11',NULL,14,NULL,9,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Kibuye Market phase 3',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofkibuyemarketphase3-0224',15000000.00),(225,'Construction of Kibuye Market phase 4','City Infrastructure Development',NULL,NULL,10000000.00,0.00,NULL,NULL,NULL,NULL,'Stalled',NULL,'2025-10-15 05:59:11',NULL,14,NULL,9,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Kibuye Market phase 4',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofkibuyemarketphase4-0225',10000000.00),(226,'Improvement of Urban Aesthetics open spaces, round abouts','City Infrastructure Development',NULL,NULL,15000000.00,0.00,NULL,NULL,NULL,NULL,'Not Started',NULL,'2025-10-15 05:59:11',NULL,14,NULL,10,NULL,NULL,NULL,'City of Kisumu infrastructure project - Improvement of Urban Aesthetics open spaces, round abouts',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'improvementofurbanaestheticsopenspaces,roundabouts-0226',15000000.00),(227,'Unblocking of drainage within the main Buspark within Kisumu City','City Infrastructure Development',NULL,NULL,5000000.00,0.00,NULL,NULL,NULL,NULL,'Stalled',NULL,'2025-10-15 05:59:11',NULL,14,NULL,5,NULL,NULL,NULL,'City of Kisumu infrastructure project - Unblocking of drainage within the main Buspark within Kisumu City',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'unblockingofdrainagewithinthemainbusparkwithinkisumucity-0227',5000000.00),(228,'Completion of Chichwa Market','City Infrastructure Development',NULL,NULL,8000000.00,0.00,NULL,NULL,NULL,NULL,'Under Procurement',NULL,'2025-10-15 05:59:11',NULL,14,NULL,5,NULL,NULL,NULL,'City of Kisumu infrastructure project - Completion of Chichwa Market',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'completionofchichwamarket-0228',8000000.00),(229,'Completion of Kosawo Market wall Fence','City Infrastructure Development',NULL,NULL,3000000.00,0.00,NULL,NULL,NULL,NULL,'Ongoing',NULL,'2025-10-15 05:59:11',NULL,14,NULL,5,NULL,NULL,NULL,'City of Kisumu infrastructure project - Completion of Kosawo Market wall Fence',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'completionofkosawomarketwallfence-0229',3000000.00),(230,'Completion of Kibuye Market phase 5','City Infrastructure Development',NULL,NULL,12000000.00,0.00,NULL,NULL,NULL,NULL,'Completed',NULL,'2025-10-15 05:59:11',NULL,14,NULL,5,NULL,NULL,NULL,'City of Kisumu infrastructure project - Completion of Kibuye Market phase 5',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'completionofkibuyemarketphase5-0230',12000000.00),(231,'Construction of Kibuye Market phase 6','City Infrastructure Development',NULL,NULL,10000000.00,0.00,NULL,NULL,NULL,NULL,'Completed',NULL,'2025-10-15 05:59:11',NULL,14,NULL,5,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Kibuye Market phase 6',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofkibuyemarketphase6-0231',10000000.00),(232,'Construction of Kibuye Market phase 7','City Infrastructure Development',NULL,NULL,8000000.00,0.00,NULL,NULL,NULL,NULL,'Under Procurement',NULL,'2025-10-15 05:59:11',NULL,14,NULL,5,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Kibuye Market phase 7',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofkibuyemarketphase7-0232',8000000.00),(233,'Construction of Kibuye Market phase 8','City Infrastructure Development',NULL,NULL,6000000.00,0.00,NULL,NULL,NULL,NULL,'Stalled',NULL,'2025-10-15 05:59:11',NULL,14,NULL,5,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Kibuye Market phase 8',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofkibuyemarketphase8-0233',6000000.00),(234,'Construction of Kibuye Market phase 9','City Infrastructure Development',NULL,NULL,4000000.00,0.00,NULL,NULL,NULL,NULL,'Completed',NULL,'2025-10-15 05:59:11',NULL,14,NULL,5,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Kibuye Market phase 9',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofkibuyemarketphase9-0234',4000000.00),(235,'Construction of Kibuye Market phase 10','City Infrastructure Development',NULL,NULL,2000000.00,0.00,NULL,NULL,NULL,NULL,'Ongoing',NULL,'2025-10-15 05:59:11',NULL,14,NULL,5,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Kibuye Market phase 10',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofkibuyemarketphase10-0235',2000000.00),(236,'Construction of Kibuye Market phase 11','City Infrastructure Development',NULL,NULL,1000000.00,0.00,NULL,NULL,NULL,NULL,'Not Started',NULL,'2025-10-15 05:59:11',NULL,14,NULL,5,NULL,NULL,NULL,'City of Kisumu infrastructure project - Construction of Kibuye Market phase 11',1,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'constructionofkibuyemarketphase11-0236',1000000.00),(237,'PAMJOS-KANYAMEDHA ROAD',NULL,'2022-07-10 00:00:00','2023-01-08 00:00:00',100000000.00,30000000.00,NULL,NULL,NULL,NULL,'Under Procurement',NULL,'2025-10-20 12:10:25',NULL,15,NULL,5,NULL,NULL,NULL,'Construction of the PAMJOS-KANYAMEDHA ROAD',NULL,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'PMO-001',70000000.00),(238,'Migosi Mamboleo Road',NULL,'2024-10-07 00:00:00','2025-08-01 00:00:00',100000000.00,30000000.00,NULL,NULL,NULL,NULL,'Not Started',NULL,'2025-10-20 12:10:25',NULL,15,NULL,11,NULL,NULL,NULL,'Construction of the Migosi-Mamboleo Road',NULL,0,'2025-10-22 16:19:50',NULL,0.00,NULL,NULL,'PMO-004',90000000.00);
...
--
-- Temporary view structure for view `moderation_queue`
--

DROP TABLE IF EXISTS `moderation_queue`;
/*!50001 DROP VIEW IF EXISTS `moderation_queue`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `moderation_queue` AS SELECT 
 1 AS `id`,
 1 AS `name`,
 1 AS `email`,
 1 AS `subject`,
...
CREATE TABLE `public_feedback` (
  ...
  `moderation_status` enum('pending','approved','rejected','flagged') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `moderation_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `custom_reason` text COLLATE utf8mb4_unicode_ci,
  `moderator_notes` text COLLATE utf8mb4_unicode_ci,
  `moderated_by` int DEFAULT NULL,
  `moderated_at` datetime DEFAULT NULL,
...
INSERT INTO `public_feedback` VALUES (1,'Test User','test@example.com','+254 700 000 000','Test feedback','This is a test feedback message',NULL,'pending',NULL,NULL,NULL,'2025-10-10 22:08:44','2025-10-10 22:08:44',NULL,NULL,NULL,NULL,NULL,'pending',NULL,NULL,NULL,NULL,NULL),(2,'Alfayo Kwatuha','kwatuha@gmail.com','0718109108','Improvement ','It requires more staff to run this projects',NULL,'responded','Your feedback is highly appreciated, we look forward  to increasing the number of staff for this facilicty',2,'2025-10-10 23:10:48','2025-10-10 22:09:53','2025-10-10 23:10:48',NULL,NULL,NULL,NULL,NULL,'pending',NULL,NULL,NULL,NULL,NULL),(3,'Maina Francis','fmaina@gmail.com','0718109196','Curlvert Blockage','This road has several blocked culverts causing damages to road shoulders',NULL,'pending',NULL,NULL,NULL,'2025-10-11 00:43:11','2025-10-11 00:43:11',NULL,NULL,NULL,NULL,NULL,'pending',NULL,NULL,NULL,NULL,NULL),(4,'Test User with Ratings','test.ratings@example.com','+254 712 345 678','Test Feedback with Ratings','This is a test feedback submission to verify the rating system works correctly.',NULL,'pending',NULL,NULL,NULL,'2025-10-11 22:55:26','2025-10-11 22:55:26',5,4,5,3,4,'pending',NULL,NULL,NULL,NULL,NULL),(5,'Test User without Ratings','test.no.ratings@example.com','+254 712 345 679','Test Feedback without Ratings','This feedback has no ratings - testing that they are optional.',NULL,'pending',NULL,NULL,NULL,'2025-10-11 22:55:27','2025-10-11 22:55:27',NULL,NULL,NULL,NULL,NULL,'pending',NULL,NULL,NULL,NULL,NULL),(6,'test','sdsa','sd','sd','fdfdfdsf',NULL,'pending',NULL,NULL,NULL,'2025-10-11 23:03:52','2025-10-11 23:03:52',1,1,3,5,2,'pending',NULL,NULL,NULL,NULL,NULL),(7,NULL,NULL,NULL,NULL,'This is anonymous feedback - testing that name is now optional',NULL,'pending',NULL,NULL,NULL,'2025-10-11 23:19:52','2025-10-11 23:19:52',4,NULL,NULL,NULL,NULL,'pending',NULL,NULL,NULL,NULL,NULL),(8,'','','','Feedback on: Mwingi East ICT Incubation Hub Setup','The project is taking too long to be completed',NULL,'pending',NULL,NULL,NULL,'2025-10-12 00:01:06','2025-10-12 00:01:06',1,3,2,2,4,'pending',NULL,NULL,NULL,NULL,NULL),(9,'Jane Maina','','','Feedback on: Construction of Kibuye Market phase 9','It is a great project',234,'pending',NULL,NULL,NULL,'2025-10-15 08:53:55','2025-10-15 08:53:55',1,3,2,4,4,'pending',NULL,NULL,NULL,NULL,NULL),(10,'Maurine','','','','\n Projects completion rate is slow',NULL,'responded','Our implementation team will review the status and fast track the process',2,'2025-10-15 09:28:46','2025-10-15 08:56:57','2025-10-15 09:28:46',3,3,4,4,NULL,'pending',NULL,NULL,NULL,NULL,NULL),(11,'Maurine A','','','Feedback on: Construction of Kibuye Market phase 11','The project was poorly done',236,'pending',NULL,NULL,NULL,'2025-10-15 09:34:16','2025-10-15 09:34:16',2,1,2,3,2,'pending',NULL,NULL,NULL,NULL,NULL),(12,'James Oyoo','','','Feedback on: Construction of Kibuye Market phase 11','This will be a lasting game changer in the trading culture of Kibuye Market',236,'responded','Thanks for your kind words, we endeavor to give you the best',2,'2025-10-15 13:13:05','2025-10-15 13:08:56','2025-10-22 17:12:46',4,5,5,3,4,'approved',NULL,NULL,'',NULL,'2025-10-22 17:12:46'),(13,'gggg','','','Feedback on: Construction of Nyamasaria Satelite Buspark within Kisumu City',' not done to standards',221,'pending',NULL,NULL,NULL,'2025-10-15 14:25:46','2025-10-15 14:25:46',NULL,NULL,NULL,NULL,NULL,'pending',NULL,NULL,NULL,NULL,NULL);
...
--
-- Final view structure for view `approved_public_feedback`
--
...
/*!50013 DEFINER=`impesUser`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `approved_public_feedback` AS select `f`.`id` AS `id`,`f`.`name` AS `name`,`f`.`email` AS `email`,`f`.`phone` AS `phone`,`f`.`subject` AS `subject`,`f`.`message` AS `message`,`f`.`project_id` AS `project_id`,`f`.`status` AS `status`,`f`.`admin_response` AS `admin_response`,`f`.`responded_by` AS `responded_by`,`f`.`responded_at` AS `responded_at`,`f`.`created_at` AS `created_at`,`f`.`updated_at` AS `updated_at`,`f`.`rating_overall_support` AS `rating_overall_support`,`f`.`rating_quality_of_life_impact` AS `rating_quality_of_life_impact`,`f`.`rating_community_alignment` AS `rating_community_alignment`,`f`.`rating_transparency` AS `rating_transparency`,`f`.`rating_feasibility_confidence` AS `rating_feasibility_confidence`,`f`.`moderation_status` AS `moderation_status`,`f`.`moderation_reason` AS `moderation_reason`,`f`.`custom_reason` AS `custom_reason`,`f`.`moderator_notes` AS `moderator_notes`,`f`.`moderated_by` AS `moderated_by`,`f`.`moderated_at` AS `moderated_at`,`p`.`projectName` AS `project_name`,`u`.`firstName` AS `moderator_first_name`,`u`.`lastName` AS `moderator_last_name` from ((`public_feedback` `f` left join `kemri_projects` `p` on((`f`.`project_id` = `p`.`id`))) left join `kemri_users` `u` on((`f`.`moderated_by` = `u`.`userId`))) where (`f`.`moderation_status` = 'approved') order by `f`.`created_at` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `moderation_queue`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`impesUser`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `moderation_queue` AS select `f`.`id` AS `id`,`f`.`name` AS `name`,`f`.`email` AS `email`,`f`.`subject` AS `subject`,`f`.`message` AS `message`,`f`.`project_id` AS `project_id`,`f`.`status` AS `status`,`f`.`moderation_status` AS `moderation_status`,`f`.`moderation_reason` AS `moderation_reason`,`f`.`custom_reason` AS `custom_reason`,`f`.`moderator_notes` AS `moderator_notes`,`f`.`created_at` AS `created_at`,`f`.`updated_at` AS `updated_at`,`p`.`projectName` AS `project_name`,concat(`u`.`firstName`,' ',`u`.`lastName`) AS `moderator_name`,'public_feedback' AS `feedback_type` from ((`public_feedback` `f` left join `kemri_projects` `p` on((`f`.`project_id` = `p`.`id`))) left join `kemri_users` `u` on((`f`.`moderated_by` = `u`.`userId`))) where (`f`.`moderation_status` = 'pending') order by `f`.`created_at` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-10-22 19:59:58
