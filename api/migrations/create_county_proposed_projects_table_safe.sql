-- Create table for County Proposed Projects (Safe version without strict foreign keys)
...
SET @sql = IF(@table_exists > 0,
  'ALTER TABLE county_proposed_projects ADD CONSTRAINT fk_created_by FOREIGN KEY (created_by) REFERENCES kemri_users(userId) ON DELETE SET NULL',
