-- Create table for Project Announcements (Safe version without strict foreign keys)
...
SET @sql = IF(@table_exists > 0,
  'ALTER TABLE project_announcements ADD CONSTRAINT fk_announcement_created_by FOREIGN KEY (created_by) REFERENCES kemri_users(userId) ON DELETE SET NULL',
